...
describe("GatherSYLEvent", function () {
    ...
    it("staking test", async function () {
        console.log(await V1Instance.connect(signerList[1]).tokenByIndex("0"));
        const tokenId = "4";
        await (
        ...
        expect(String(await V1Instance.balanceOf(GatherSYLInstance.address))).equal("1");
        expect(String(await V1Instance.balanceOf(signerList[1].address))).equal("4");
        ...
        expect(String(await V1Instance.balanceOf(GatherSYLInstance.address))).equal("0");
        expect(String(await V1Instance.balanceOf(signerList[1].address))).equal("5");
    });
